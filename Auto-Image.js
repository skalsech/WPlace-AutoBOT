; (async () => {
  ...
  const TEXT = {
    ...
    es: {
      ...
      noColorsFound: "❌ ¡Abre la paleta de colores en el sitio y vuelve a intentar!",
      ...
      tokenReady: "✅ Generador de tokens listo - ¡ya puedes empezar a pintar!",
      tokenRetryLater: "⚠️ El generador de tokens volverá a intentar cuando sea necesario",
      resizeSuccess: "✅ Imagen redimensionada a {width}x{height}",
      paintingPaused: "⏸️ Pintura pausada en la posición X: {x}, Y: {y}",
      captchaNeeded: "❗ Falló la generación de token. Por favor intenta de nuevo en un momento.",
      ...
      autoCaptchaDesc: "Genera automáticamente tokens Turnstile usando el generador integrado. Se recurre a la automatización del navegador si es necesario.",
      ...
      captchaFailed: "❌ Falló la generación de token Turnstile. Probando método alternativo...",
      automation: "Automatización",
      noChargesThreshold: "⌛ Esperando que las cargas alcancen {threshold}. Actualmente {current}. Siguiente en {time}...",
    },
  }
