;(async () => {
  ...
  PAINTING_SPEED: {
    ...
    // Corresponds to IDs 32-61 from the main palette
    PAID_COLORS: new Set([
        "125,199,255", "77,49,184", "107,80,246", "153,177,251", "74,66,132", "122,113,196", "181,174,241", "170,56,185", "224,159,249", "203,0,122",
        "236,31,128", "243,141,169", "155,82,73", "209,128,120", "250,182,164", "104,70,52", "149,104,42", "219,164,99", "123,99,82", "156,132,107",
        "214,181,148", "209,128,81", "248,178,119", "255,197,165", "109,100,63", "148,140,107", "205,197,158", "51,57,65", "109,117,141", "179,185,209"
    ]),
    // --- END: Color data ---
  ...
  async function initializeOverlay() {
      ...
      state.overlayCanvas.style.zIndex = '1'; // Just above the game canvas
      state.overlayCanvas.style.display = 'none';
      state.overlayCanvas.style.imageRendering = 'pixelated'; // Keep pixels sharp
      ...
      const syncOverlay = () => {
          ...
          // The canvas element's width/height attributes are the resolution
          // The style width/height are the display size, but transform handles that.
          state.overlayCanvas.width = state.gameCanvas.width;
          state.overlayCanvas.height = state.gameCanvas.height;
          // Copy position and transform to align perfectly
