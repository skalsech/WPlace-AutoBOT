...
; (async () => {
  ...
  const TEXT = {
    ...
    uk: {
      ...
      autoCaptchaDesc:
        'Автоматично генерує токени Turnstile за допомогою вбудованого генератора. Використовує автоматизацію браузера у разі потреби.',
      ...
      noChargesThreshold:
        '⌛ Очікування, доки заряди досягнуть {threshold}. Зараз {current}. Наступне через {time}...',
    },
  };
